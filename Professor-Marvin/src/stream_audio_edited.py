...
class StreamPrediction:
    ...
    def load_models(self, model_path):
        ...
        self.feature_extractor = tf.lite.Interpreter(model_path = "/content/drive/MyDrive/TinyML/TinyML Project/tf_lite_model_1204_60ep_pr86.tflite")
    ...
    def detect_keyword(self, fbank):
        ...
        self.feature_extractor.set_tensor((1, 99, 40), fbank)
        self.feature_extractor.invoke()
        output_data = self.feature_extractor.get_tensor((1,31))
